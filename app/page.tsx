...
import { AnnouncementBar } from "A/components/layout/announcement-bar";
...
import { MediaStrip } from "A/components/sections/media-strip";
import { Templates } from "A/components/sections/templates";
...
import DailyBonusModal from "A/components/modals/daily-bonus-modal";
import PaywallModal from "A/components/modals/paywall-modal";
    ...
    <div className="grid grid-cols-[240px_1fr] min-h-screen">
      ...
      <div className="flex flex-col min-h-screen">
        ...
        <div className="px-10 max-w-[1160px] mx-auto w-full flex-1">
          ...
          <InlineUpsell onUpgrade={() => openPaywall("ґЅев модели", "pro")} />
          ...
          <div id="pricing">
            <Pricing onSelectPlan={(plan: string) => showToast(`Аыбран тариф: ${plan}`)} />
          </div>
